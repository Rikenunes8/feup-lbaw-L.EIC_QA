...
<form method="POST" action="{{ route('ucs.create') }}" id="form-uc-create" class="row w-50 mx-auto">
    ...
    <div class="mb-3 col-12">
        ...
        <input type="text" id="name" class="form-control" name="name" value="{{ is_null(old('name'))?'':old('name') }}" required>
        @if ($errors->has('name'))
    ...
    <div class="mb-3 col-12">
        ...
        <input type="text" id="code" class="form-control" name="code" value="{{ is_null(old('code'))?'':old('code') }}" required>
        @if ($errors->has('code'))
    ...
    <div class="mb-3 col-12">
        ...
        <textarea rows="3" id="description" class="form-control" name="description" required>{{ is_null(old('description'))?'':old('description') }}</textarea>
